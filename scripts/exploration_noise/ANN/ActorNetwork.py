...
class ActorNetwork(object):
    ...
    def create_actor_network(self, state_size,action_dim):
        ...
        h0 = Dense(500, activation='relu', name='HiddenLayer0')(S)
        h1 = Dense(500, activation='relu', name='HiddenLayer1')(h0)
        h2 = Dense(500, activation='relu', name='HiddenLayer2')(h1)
        ...
        omega_left_wheel = Dense(1, activation='tanh', init=RandomNormal(stddev=1e-4), name='action_left_wheel')(h2)
        omega_right_wheel = Dense(1, activation='tanh', init=RandomNormal(stddev=1e-4), name='action_right_wheel')(h2)
